export const fullVersionLink = "https://resume.psknew.netlify.app/"
export const sourceLink = "https://github.com/passakorn-new/resume"
...
export const introData = {
  name: "Passakorn Kijudomsup",
  nickname: "New",
  phone: "098-275-8088",
  email: "passakorn.kijudomsup@gmail.com",
  github: "passakorn-new",
  linkedin: "psknew",
...
export const educations = [
  {
    ...
    details: "King Mongkut's University of Technology North Bangkok, TH. 2015-2019 (GPA 3.59)",
  },
  {
    head: "Math Science",
    details: "Rattanakosin Sompoch Bangkhunthian School, TH. 2011-2014 (GPA 3.13)",
  },
]
...
export const workExperiences = [
  ...
  {
    position: "Programmer (Internship 7 months)",
    company: "Sycapt",
...
export const projects = [
  {
    name: "Portfolio",
    details:
      "Website collect my profile, projects and writing",
    url: "psknew.netlify.app",
  },
  {
    name: "Go Clean Architect",
    details:
